...
export const CMD_TBL = {
  ...
  SNMP_COMMUNITY_MAP_MODE: "snmp community-map mode enable",
  SNMP_STATION: 'snmp station %_DATA_% 162 "%_DATA_%" %_DATA_% enable',
  SNMP_STATION_V2: 'snmp station %_DATA_% %_DATA_% v2 enable',
  DELETE_COMMUNITY: "no snmp community-map %_DATA_%",
  DELETE_STATION: "no snmp station %_DATA_%",
  AAA_AUTH_SNMP_LOCAL: "aaa authentication snmp local",
  SNMP_USER_NO_AUTH: 'snmp user %_DATA_% %_DATA_% read-write all no auth',
  SNMP_SECURITY_NO_SECURITY: "snmp security no-security",
